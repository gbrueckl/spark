...
DOTNET_SPARK_GITHUB_RELEASE=https://github.com/dotnet/spark/releases/download/v0.2.0/Microsoft.Spark.Worker.netcoreapp2.1.linux-x64-0.2.0.tar.gz
...
set +e
/bin/bash $DBFS_INSTALLATION_ROOT/install-worker.sh github $DOTNET_SPARK_GITHUB_RELEASE $DOTNET_SPARK_WORKER_INSTALLATION_PATH
